...
export default function WhatWeDo() {
  ...
  return (
    <section className="py-12 md:py-24 font-ibm bg-orange-500 px-4">
      <div className="flex flex-col justify-center items-center mb-14">
        <h2 className="text-4xl text-white font-semibold">Our Programs</h2>
      ...
      {whatWeDoData.map((section, index) => {
        ...
        return (
          <div key={index} className="md:max-w-screen-xl bg-orange-200 mx-auto rounded-lg shadow-lg p-8 md:p-14 md:flex md:space-x-8 mt-8">
