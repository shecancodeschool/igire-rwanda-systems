  ...
  return (
    <div className="md:flex md:justify-center py-12 md:py-24 px-4 bg-orange-500">
      <div className="w-full text-center flex flex-col justify-center items-center gap-5 md:gap-10 font-ibm">
        ...
        <p className="font-ibm text-lg w-full md:w-2/3">We encourage pertnership and collaboration to support our mission. We therefore welcome anyone who is interested in empowering youth.</p>
