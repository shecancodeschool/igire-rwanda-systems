    ...
    return (
        <div className="bg-orange-50 shadow-md">
            ...
            <div className="p-6">
                ...
                <Link href={`/blog/${article.slug}`} className="text-green-800 group hover:text-green-600 hover:bg-transparent font-bold text-lg px-3 py-1 flex items-center w-fit">
                    Read More
